...
from . import properties, bone_mapping, face_mapping, hand_mapping, character_builder, cartoon_style, operators, panel

del bone_mapping, face_mapping, hand_mapping, character_builder, cartoon_style  # importés pour s'assurer qu'ils se chargent sans erreur
